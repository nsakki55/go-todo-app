...
//			LoginFunc: func(ctx context.Context, user string, pw string) (string, error) {
...
func (mock *LoginServiceMock) Login(ctx context.Context, user string, pw string) (string, error) {
	...
	return mock.LoginFunc(ctx, user, pw)
}
